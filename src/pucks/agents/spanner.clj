...
;; Definitions for spanner agents.

(ns pucks.agents.spanner
...
(defn spanner 
  ...
  (merge (active)
         {:spanner true
          :proposal-function spanner-proposals
