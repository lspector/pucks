...
var G__4366 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4366;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4367 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4367,ch);
...
if(("\\" === ch__$1)){
var ch_4368__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4368__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4368__$2);
} else {
}

var G__4369 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4369;
continue;
}
}
...
var vec__4377 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4377,(0),null);
var start_column = cljs.core.nth.call(null,vec__4377,(1),null);
...
var G__4380 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4380;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4381 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4382 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4382;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4381;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4383 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4383,(0),null);
var start_column = cljs.core.nth.call(null,vec__4383,(1),null);
...
var vec__4386 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4386,(0),null);
var end_column = cljs.core.nth.call(null,vec__4386,(1),null);
...
var vec__4389 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4389,(0),null);
var start_column = cljs.core.nth.call(null,vec__4389,(1),null);
...
var vec__4392 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4392,(0),null);
var end_column = cljs.core.nth.call(null,vec__4392,(1),null);
...
var vec__4395 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4395,(0),null);
var start_column = cljs.core.nth.call(null,vec__4395,(1),null);
...
var vec__4398 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4398,(0),null);
var end_column = cljs.core.nth.call(null,vec__4398,(1),null);
...
var sb = (function (){var G__4401 = (new goog.string.StringBuffer());
G__4401.append(initch);
...
var G__4403 = (function (){var G__4402 = sb;
G__4402.append(ch);

return G__4402;
})();
var G__4404 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4403;
ch = G__4404;
continue;
}
...
switch (G__4407) {
case "\\":
var G__4411 = (function (){var G__4408 = sb;
G__4408.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4408;
})();
var G__4412 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4411;
ch = G__4412;
continue;
...
break;
default:
var G__4413 = (function (){var G__4409 = sb;
G__4409.append(ch);

return G__4409;
})();
var G__4414 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4413;
ch = G__4414;
continue;
...
var vec__4415 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4415,(0),null);
var end_column = cljs.core.nth.call(null,vec__4415,(1),null);
...
var vec__4418 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4418,(0),null);
var column = cljs.core.nth.call(null,vec__4418,(1),null);
...
var vec__4423 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4423,(0),null);
var column = cljs.core.nth.call(null,vec__4423,(1),null);
...
var vec__4428 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4428,(0),null);
var column = cljs.core.nth.call(null,vec__4428,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4433 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4433,(0),null);
var start_column = cljs.core.nth.call(null,vec__4433,(1),null);
...
var vec__4436 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4436,(0),null);
var end_column = cljs.core.nth.call(null,vec__4436,(1),null);
...
var G__4439 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4439,true,null,opts,pending_forms);
...
var G__4440 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4440)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4440)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4440)){
...
var _STAR_suppress_read_STAR__orig_val__4441 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4442 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4442;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4441;
}});
...
var G__4443 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4443,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4443,rdr,first_line);
...
var G__4447 = matched;
var G__4448 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4447;
finished = G__4448;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__4449 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4450 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4450;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4449;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4451 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4452 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__4452;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4453 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4453,"(");
...
var G__4454 = (i + (1));
var G__4455 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__4451;
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4456 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4456);
...
var G__4457 = cljs.core.next.call(null,s__$1);
var G__4458 = ret;
s__$1 = G__4457;
r = G__4458;
continue;
...
var G__4460 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4459;
key_vals = G__4460;
continue;
} else {
...
var gensym_env_orig_val__4464 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4465 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__4465;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__4464;
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4466 = token;
var G__4466__$1 = (((G__4466 == null))?null:cljs.core.subs.call(null,G__4466,(1)));
var G__4466__$2 = (((G__4466__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4466__$1));
var G__4466__$3 = (((G__4466__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4466__$2));
var G__4466__$4 = (((G__4466__$3 == null))?null:cljs.core.symbol.call(null,G__4466__$3));
if((G__4466__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4466__$4);
}
})():(function (){var G__4467 = token;
var G__4467__$1 = (((G__4467 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4467));
if((G__4467__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4467__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e4474){if((e4474 instanceof Error)){
var e = e4474;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4478,reader){
var map__4479 = p__4478;
...
var opts = map__4479__$1;
var eof = cljs.core.get.call(null,map__4479__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___4487 = arguments.length;
var i__4731__auto___4488 = (0);
while(true){
if((i__4731__auto___4488 < len__4730__auto___4487)){
args__4736__auto__.push((arguments[i__4731__auto___4488]));

var G__4489 = (i__4731__auto___4488 + (1));
i__4731__auto___4488 = G__4489;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq4485){
var G__4486 = cljs.core.first.call(null,seq4485);
var seq4485__$1 = cljs.core.next.call(null,seq4485);
