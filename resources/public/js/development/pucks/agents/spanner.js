...
var vec__3393 = color_key.call(null,p1);
var r1 = cljs.core.nth.call(null,vec__3393,(0),null);
var g1 = cljs.core.nth.call(null,vec__3393,(1),null);
var b1 = cljs.core.nth.call(null,vec__3393,(2),null);
var vec__3396 = color_key.call(null,p2);
var r2 = cljs.core.nth.call(null,vec__3396,(0),null);
var g2 = cljs.core.nth.call(null,vec__3396,(1),null);
var b2 = cljs.core.nth.call(null,vec__3396,(2),null);
...
return (function (p1__3399_SHARP_){
return pucks.agents.spanner.self.call(null,p,p1__3399_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"color","color",1011675173));
...
return (function (p1__3400_SHARP_){
return (!(pucks.agents.spanner.self.call(null,p,p1__3400_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"color","color",1011675173))));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__3407),pucks$agents$spanner$spanner_proposals_$_iter__3404.call(null,cljs.core.chunk_rest.call(null,s__3405__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__3407),null);
}
} else {
var binder = cljs.core.first.call(null,s__3405__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(binder),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bound-to","bound-to",-1422182221),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p)], null),new cljs.core.Keyword(null,"ask","ask",707712414),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bound-to","bound-to",-1422182221),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(binder)], null)], null),pucks$agents$spanner$spanner_proposals_$_iter__3404.call(null,cljs.core.rest.call(null,s__3405__$2)));
}
} else {
return null;
}
...
return (function (p1__3401_SHARP_){
return pucks.agents.spanner.self.call(null,p,p1__3401_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"eye-color","eye-color",1844620441));
...
return (function pucks$agents$spanner$spanner_proposals_$_iter__3408(s__3409){
return (new cljs.core.LazySeq(null,((function (selves,others,vents,zappers,g,temp__5733__auto__){
return (function (){
var s__3409__$1 = s__3409;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__3409__$1);
if(temp__5735__auto__){
var s__3409__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__3409__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__3409__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__3411 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__3410 = (0);
while(true){
if((i__3410 < size__4522__auto__)){
var weaker = cljs.core._nth.call(null,c__4521__auto__,i__3410);
cljs.core.chunk_append.call(null,b__3411,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(weaker),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null));

var G__3413 = (i__3410 + (1));
i__3410 = G__3413;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__3411),pucks$agents$spanner$spanner_proposals_$_iter__3408.call(null,cljs.core.chunk_rest.call(null,s__3409__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__3411),null);
}
} else {
var weaker = cljs.core.first.call(null,s__3409__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(weaker),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null),pucks$agents$spanner$spanner_proposals_$_iter__3408.call(null,cljs.core.rest.call(null,s__3409__$2)));
}
} else {
return null;
}
...
;
return iter__4523__auto__.call(null,cljs.core.filter.call(null,((function (iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__){
return (function (p1__3402_SHARP_){
return (new cljs.core.Keyword(null,"energy","energy",129856526).cljs$core$IFn$_invoke$arity$1(p1__3402_SHARP_) < new cljs.core.Keyword(null,"energy","energy",129856526).cljs$core$IFn$_invoke$arity$1(p));
});})(iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__))
,cljs.core.filter.call(null,((function (iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__){
return (function (p1__3403_SHARP_){
return pucks.agents.spanner.self.call(null,p,p1__3403_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"core-color","core-color",278930388));
});})(iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__))
,cljs.core.filter.call(null,new cljs.core.Keyword(null,"spanner","spanner",-643354678),new cljs.core.Keyword(null,"overlaps","overlaps",1398230580).cljs$core$IFn$_invoke$arity$1(p)))));
})())], null));
} else {
...
return cljs.core.mapv.call(null,(function (p1__3414_SHARP_){
return cljs.core.mod.call(null,(p1__3414_SHARP_ + (cljs.core.rand_int.call(null,(33)) - (16))),(256));
}),c);
});
/**
...
return cljs.core.merge.call(null,pucks.agents.active.active.call(null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"spanner","spanner",-643354678),true,new cljs.core.Keyword(null,"proposal-function","proposal-function",-646608988),pucks.agents.spanner.spanner_proposals,new cljs.core.Keyword(null,"memory","memory",-1449401430),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"genome","genome",-1313307628),cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"other-flock-urge","other-flock-urge",-1196306783),new cljs.core.Keyword(null,"self-cluster-urge","self-cluster-urge",-1948755134),new cljs.core.Keyword(null,"color","color",1011675173),new cljs.core.Keyword(null,"spawn-probability","spawn-probability",-875578456),new cljs.core.Keyword(null,"random-urge","random-urge",291214603),new cljs.core.Keyword(null,"self-flock-urge","self-flock-urge",-2009717300),new cljs.core.Keyword(null,"vent-urge","vent-urge",1504560012),new cljs.core.Keyword(null,"zapper-urge","zapper-urge",1439435022),new cljs.core.Keyword(null,"core-color","core-color",278930388),new cljs.core.Keyword(null,"color-difference","color-difference",56446998),new cljs.core.Keyword(null,"other-cluster-urge","other-cluster-urge",1841126518),new cljs.core.Keyword(null,"eye-color","eye-color",1844620441)],[pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_color.call(null),pucks.agents.spanner.rand_probability.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_color.call(null),pucks.agents.spanner.rand_color_difference.call(null),pucks.agents.spanner.rand_urge.call(null),pucks.agents.spanner.rand_color.call(null)])], null),new cljs.core.Keyword(null,"spawn-function","spawn-function",661653620),(function (p1__3415_SHARP_){
return cljs.core.merge.call(null,p1__3415_SHARP_,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"velocity","velocity",-581524355),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [((5) * (cljs.core.rand.call(null) - 0.5)),((5) * (cljs.core.rand.call(null) - 0.5))], null),new cljs.core.Keyword(null,"rotation","rotation",-1728051644),(pucks.globals.two_pi * cljs.core.rand.call(null)),new cljs.core.Keyword(null,"position","position",-2011731912),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.rand_int.call(null,(3)) - (1)),(cljs.core.rand_int.call(null,(3)) - (1))], null),new cljs.core.Keyword(null,"memory","memory",-1449401430),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"genome","genome",-1313307628),pucks.agents.spanner.mutate.call(null,new cljs.core.Keyword(null,"genome","genome",-1313307628).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"memory","memory",-1449401430).cljs$core$IFn$_invoke$arity$1(p1__3415_SHARP_)))], null)], null));
})], null));
});
