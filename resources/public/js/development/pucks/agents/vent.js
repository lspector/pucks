...
var vec__6572 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(p);
var x = cljs.core.nth.call(null,vec__6572,(0),null);
var y = cljs.core.nth.call(null,vec__6572,(1),null);
var radius = new cljs.core.Keyword(null,"radius","radius",-2073122258).cljs$core$IFn$_invoke$arity$1(p);
var vec__6575 = new cljs.core.Keyword(null,"color","color",1011675173).cljs$core$IFn$_invoke$arity$1(p);
var r = cljs.core.nth.call(null,vec__6575,(0),null);
var g = cljs.core.nth.call(null,vec__6575,(1),null);
var b = cljs.core.nth.call(null,vec__6575,(2),null);
var vec__6578 = new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(238),(118),(0)], null);
var core_r = cljs.core.nth.call(null,vec__6578,(0),null);
var core_g = cljs.core.nth.call(null,vec__6578,(1),null);
var core_b = cljs.core.nth.call(null,vec__6578,(2),null);
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"transfer","transfer",327423400),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,(function (){var iter__4523__auto__ = (function pucks$agents$vent$vent_proposals_$_iter__6581(s__6582){
return (new cljs.core.LazySeq(null,(function (){
var s__6582__$1 = s__6582;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__6582__$1);
if(temp__5735__auto__){
var s__6582__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__6582__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__6582__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__6584 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__6583 = (0);
while(true){
if((i__6583 < size__4522__auto__)){
var recipient = cljs.core._nth.call(null,c__4521__auto__,i__6583);
cljs.core.chunk_append.call(null,b__6584,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(recipient),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null));

var G__6585 = (i__6583 + (1));
i__6583 = G__6585;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6584),pucks$agents$vent$vent_proposals_$_iter__6581.call(null,cljs.core.chunk_rest.call(null,s__6582__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__6584),null);
}
} else {
var recipient = cljs.core.first.call(null,s__6582__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(recipient),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null),pucks$agents$vent$vent_proposals_$_iter__6581.call(null,cljs.core.rest.call(null,s__6582__$2)));
}
} else {
return null;
}
