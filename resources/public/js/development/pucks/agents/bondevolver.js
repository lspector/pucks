...
var vec__7866 = color_key.call(null,p1);
var r1 = cljs.core.nth.call(null,vec__7866,(0),null);
var g1 = cljs.core.nth.call(null,vec__7866,(1),null);
var b1 = cljs.core.nth.call(null,vec__7866,(2),null);
var vec__7869 = color_key.call(null,p2);
var r2 = cljs.core.nth.call(null,vec__7869,(0),null);
var g2 = cljs.core.nth.call(null,vec__7869,(1),null);
var b2 = cljs.core.nth.call(null,vec__7869,(2),null);
...
return pucks.agents.bondevolver.self.call(null,p,p1__7872_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"color","color",1011675173));
...
return (!(pucks.agents.bondevolver.self.call(null,p,p1__7873_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"color","color",1011675173))));
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7880),pucks$agents$bondevolver$bondevolver_proposals_$_iter__7877.call(null,cljs.core.chunk_rest.call(null,s__7878__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7880),null);
}
} else {
var binder = cljs.core.first.call(null,s__7878__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(binder),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bound-to","bound-to",-1422182221),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p)], null),new cljs.core.Keyword(null,"ask","ask",707712414),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"bound-to","bound-to",-1422182221),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(binder)], null)], null),pucks$agents$bondevolver$bondevolver_proposals_$_iter__7877.call(null,cljs.core.rest.call(null,s__7878__$2)));
}
} else {
return null;
}
...
return pucks.agents.bondevolver.self.call(null,p,p1__7874_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"eye-color","eye-color",1844620441));
...
return (function pucks$agents$bondevolver$bondevolver_proposals_$_iter__7881(s__7882){
return (new cljs.core.LazySeq(null,((function (selves,others,vents,zappers,g,temp__5733__auto__){
return (function (){
var s__7882__$1 = s__7882;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__7882__$1);
if(temp__5735__auto__){
var s__7882__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__7882__$2)){
var c__4521__auto__ = cljs.core.chunk_first.call(null,s__7882__$2);
var size__4522__auto__ = cljs.core.count.call(null,c__4521__auto__);
var b__7884 = cljs.core.chunk_buffer.call(null,size__4522__auto__);
if((function (){var i__7883 = (0);
while(true){
if((i__7883 < size__4522__auto__)){
var weaker = cljs.core._nth.call(null,c__4521__auto__,i__7883);
cljs.core.chunk_append.call(null,b__7884,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(weaker),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null));

var G__7886 = (i__7883 + (1));
i__7883 = G__7886;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7884),pucks$agents$bondevolver$bondevolver_proposals_$_iter__7881.call(null,cljs.core.chunk_rest.call(null,s__7882__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__7884),null);
}
} else {
var weaker = cljs.core.first.call(null,s__7882__$2);
return cljs.core.cons.call(null,new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"self","self",-1547428899),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p),new cljs.core.Keyword(null,"other","other",995793544),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(weaker),new cljs.core.Keyword(null,"bid","bid",-1944960257),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"energy","energy",129856526),0.01], null),new cljs.core.Keyword(null,"ask","ask",707712414),cljs.core.PersistentArrayMap.EMPTY], null),pucks$agents$bondevolver$bondevolver_proposals_$_iter__7881.call(null,cljs.core.rest.call(null,s__7882__$2)));
}
} else {
return null;
}
...
return (new cljs.core.Keyword(null,"energy","energy",129856526).cljs$core$IFn$_invoke$arity$1(p1__7875_SHARP_) < new cljs.core.Keyword(null,"energy","energy",129856526).cljs$core$IFn$_invoke$arity$1(p));
});})(iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__))
...
return pucks.agents.bondevolver.self.call(null,p,p1__7876_SHARP_,new cljs.core.Keyword(null,"color-difference","color-difference",56446998).cljs$core$IFn$_invoke$arity$1(g),new cljs.core.Keyword(null,"core-color","core-color",278930388));
});})(iter__4523__auto__,selves,others,vents,zappers,g,temp__5733__auto__))
,cljs.core.filter.call(null,new cljs.core.Keyword(null,"bondevolver","bondevolver",-1381974329),new cljs.core.Keyword(null,"overlaps","overlaps",1398230580).cljs$core$IFn$_invoke$arity$1(p)))));
})())], null));
} else {
...
return cljs.core.mapv.call(null,(function (p1__7887_SHARP_){
return cljs.core.mod.call(null,(p1__7887_SHARP_ + (cljs.core.rand_int.call(null,(33)) - (16))),(256));
}),c);
});
/**
